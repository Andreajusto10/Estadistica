...
# suponga que tiene doce preguntas de opcion multiple en un
# examen de matematicas. Cada pregunta tiene cinco posibles 
# respuestas y solo una de ellas es correcta. Encuentre la
# probabilidad de tener cuatro o menos respuestas correctas
# si un estudiante intenta responder a cada pregunta al azar.

# Solucion para que saque 4 respuestas correctas:

# Dado que solo una de cada cinco respuestas posibles es
# correcta, la posibilidad de responder correctamente una
...
# 3.- Probabilidad de tener 4 respuestas correctas 
# elegidas aleatoreamente
k<-4
...
# Ejemplo de como realizar un grafico de la distribucion normal

# Rejilla de valores del eje x, **x=80**. Se va a utilizar
# el mismo valor de "X", de "n" y la probabilidad es la 
# que va a ir cambiando, en esta ocasion se ocuparán las
# probabilidades de **0.2, 0.3 y 0.4**. Ademas de poner
# la leyenda. 
...
# *Ejercicio de cómo realizar nuestro gráfico la distribución 
# binomial del ejemplo*
...
# correctas de forma aleatoria se utiliza la función dbinom con k=0,1,2,3,4.
...
#NOTA 2:* Se ponen ambos códigos de manera conjunta para que la
# leyenda salga junto con el gráfico. 
...
# artículos. ¿Cuál es la probabilidad de que una caja elegida al azar contenga
...
# Rejilla de valores del eje X, *x=0:50. Se van a utilizar el mismo de valor
# de "x", y lambda es la que va a ir cambiando, en esta ocasión se ocuparán
# valores de **5, 10 y 20*. Además de poner la leyenda. 
...
# Escuela Primaria en un lapso de 15 minutos a la entrada de la escuela. 
# Se puede suponer que la probabilidad de llegada de los estudiantes es la misma
# que cualquiera de los dos lapsos con la misma dirección siendo estas 
# independientes a que llegue o no el estudiante. El número promedio de alumnos 
# que llegan en un lapso de 15 minutos son 35. Para optimizar la llegada de los 
# estudiantes evitando las aglomeraciones se requiere saber la probabilidad de 
# que lleguen 50 alumnos en 15 minutos.

# 1.- Probabilidad de que 35 alumnos lleguen en 15 minutos a la entrada de
# la escuela
...
2.- Probabilidad de que 50 alumnos lleguen en 15 minutos a la entrada de la escuela
...
1.- ¿Cuál es la probabilidad de que a la escuela lleguen 34 alumnos en 5 minutos?
  ...
  a) Probabilidad de que 34 alumnos lleguen en 5 minutos a la entrada de la escuela
...
2.- ¿Cuál es la probabilidad de que a la salida de la escuela, se encuentren 60 alumnos en 5 minutos?
  
  a) Probabilidad de que 60 alumnos salgan en 5 minutos a la salida de la escuela
...
3.- ¿Cuál es la probabilidad de que a la salida de la escuela, se encuentren 120 alumnos en 5 minutos?
  
  a) Probabilidad de que 120 alumnos salgann en 5 minutos a la salida de la escuela
